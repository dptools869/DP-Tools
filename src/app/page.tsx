    ...
    <div className="flex flex-col">
      ...
      <section className="relative h-[60vh] md:h-[80vh] w-full flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 p-4">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight font-headline animate-fade-in-down">
            All-in-One Tools Platform
          </h1>
          <p className="max-w-2xl text-lg md:text-xl text-foreground/80 animate-fade-in-up">
            Fast, reliable, and smart tools for PDFs, Images, and Calculations
          </p>
