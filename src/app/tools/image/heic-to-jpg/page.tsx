...
import { heicToJpg, HeicToJpgOutput } from '@/ai/flows/heic-to-jpg';
...
export default function HeicToJpgPage() {
  ...
  const [conversionResult, setConversionResult] = useState<HeicToJpgOutput | null>(null);
  ...
  const convertFile = async () => {
    ...
    try {
      ...
      reader.onload = async () => {
        ...
        try {
          const result = await heicToJpg({ heicDataUri: base64File, fileName: file.name });
        ...
        <main className="lg:col-span-3">
          <Card className="shadow-2xl shadow-primary/10 border-primary/20 bg-card/80 backdrop-blur-sm mb-12 hidden md:block">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-3xl font-headline">HEIC to JPG Converter</CardTitle>
              <CardDescription className="text-lg">
                Easily convert your HEIC/HEIF images to the universally compatible JPG format.
              </CardDescription>
            </CardHeader>
          </Card>
          <Card>
          ...
          <article className="mt-16 prose prose-lg dark:prose-invert max-w-none prose-h2:font-headline prose-h2:text-3xl prose-h2:text-primary prose-a:text-primary">
            <h2 id="about-tool">Convert HEIC/HEIF Images to JPG Seamlessly</h2>
            <p>Our HEIC to JPG converter offers a straightforward solution to convert modern HEIC (High-Efficiency Image Container) and HEIF images into the universally supported JPG format. While HEIC offers superior compression, it's not yet compatible with all devices and platforms. Converting to JPG ensures your images can be viewed, shared, and edited anywhere.</p>
            <AdBanner type="top-banner" className="my-8"/>
            <h2 id="how-it-works">How Does HEIC to JPG Conversion Work?</h2>
            <p>The process is simple. Upload your HEIC or HEIF image, and our system will convert it into a high-quality JPG file. The converter ensures that the image quality is preserved during the process. Your privacy is important; all files are handled securely and automatically deleted from our servers after processing.</p>
            <h3 id="key-features">Key Features and Benefits</h3>
            <ul>
              <li><strong>Universal Compatibility:</strong> Convert to JPG to ensure your images can be viewed on any device or platform.</li>
              ...
              <li><strong>Completely Free:</strong> Convert your HEIC/HEIF images to JPG for free, without limits.</li>
            </ul>
