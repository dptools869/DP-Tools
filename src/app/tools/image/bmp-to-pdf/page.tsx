...
import { bmpToPdf, BmpToPdfOutput } from '@/ai/flows/bmp-to-pdf';
import AdBanner from '@/components/ad-banner';

export default function BmpToPdfPage() {
  const [file, setFile] = useState<File | null>(null);
  const [isConverting, setIsConverting] = useState(false);
  const [conversionResult, setConversionResult] = useState<BmpToPdfOutput | null>(null);
  ...
  const convertFile = async () => {
    ...
    try {
      ...
      reader.onload = async () => {
        ...
        try {
          const result = await bmpToPdf({ bmpDataUri: base64File, fileName: file.name });
        ...
        <main className="lg:col-span-3">
          <Card className="shadow-2xl shadow-primary/10 border-primary/20 bg-card/80 backdrop-blur-sm">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-3xl font-headline">BMP to PDF Converter</CardTitle>
              <CardDescription className="text-lg">
                Effortlessly convert your BMP image files into professional, high-quality PDFs.
              </CardDescription>
            </CardHeader>
          ...
          <article className="mt-16 prose prose-lg dark:prose-invert max-w-none prose-h2:font-headline prose-h2:text-3xl prose-h2:text-primary prose-a:text-primary">
            <h2 id="about-tool">Mastering BMP to PDF Conversion</h2>
            <p>Our BMP to PDF converter offers a seamless, powerful, and free solution to convert your bitmap images into universally accessible PDF files. This tool is meticulously engineered for professionals and hobbyists who need to compile images into a standard document format. Whether you're archiving images, creating reports, or preparing documents for printing, our tool ensures your content is perfectly preserved in a high-quality PDF.</p>
            <AdBanner type="top-banner" className="my-8"/>
            <h2 id="how-it-works">How Does the BMP to PDF Converter Work?</h2>
            <p>The process is designed to be intuitive and straightforward. When you upload a BMP file, our system processes the image and embeds it into a PDF document. This includes preserving the image quality and dimensions. The core of this technology ensures that what you see in your image file is what you get in your PDF. We prioritize security and privacy; your uploaded files are encrypted during transit and automatically deleted from our servers after a short period, guaranteeing your data remains confidential.</p>
            <h3 id="key-features">Key Features and Benefits</h3>
            <ul>
              <li><strong>High-Fidelity Conversion:</strong> Retain the exact look and feel of your original BMP image.</li>
              ...
              <li><strong>Completely Free:</strong> DP Tools is committed to providing powerful utilities at no cost. This BMP to PDF converter is free for unlimited use, without watermarks or hidden fees.</li>
            </ul>
            <p>In essence, the DP Tools BMP to PDF converter is more than just a utility; it's a bridge between your image files and the static, reliable world of PDF documents. It's an indispensable asset for anyone looking to streamline their digital life and enhance productivity. Experience the power of seamless conversion and unlock the full potential of your images today.</p>
          </article>
