        ...
        <main className="lg:col-span-3">
          ...
          <Card>
            <CardHeader className="md:hidden">
              <CardTitle>Word to JPG Converter</CardTitle>
            </CardHeader>
          ...
          <article className="mt-16 prose prose-lg dark:prose-invert max-w-none prose-h2:font-headline prose-h2:text-3xl prose-h2:text-primary prose-a:text-primary">
            ...
            <p>Unlock the visual content of your Word documents by converting them into high-quality JPG images. Our Word to JPG converter is an essential tool for creating shareable previews, social media posts, or embedding document content into websites. This is ideal for marketers, designers, and anyone needing to share document content as images. We handle multi-page documents by conveniently packaging all your converted JPGs into a single ZIP file for easy download.</p>
            <AdBanner type="top-banner" className="my-8"/>
            <h2>How Does DOC to JPG Conversion Work?</h2>
            <p>Our tool simplifies the process of converting a Word document into a series of JPG images. When you upload a DOC or DOCX file, our service communicates with a powerful conversion engine that renders each page of your document individually. This rendering process creates a high-resolution snapshot of each page, capturing all text, graphics, and layout elements exactly as they appear. These snapshots are then encoded as high-quality JPG images.</p>
            <ul>
              ...
              <li><strong>High-Quality Output:</strong> The conversion maintains a high quality to ensure the resulting JPGs are crisp and clear.</li>
            ...
            <ul>
                <li><strong>Universal Sharing:</strong> JPG is one of the most widely supported image formats, viewable on any device.</li>
                <li><strong>Web-Friendly:</strong> Create optimized images perfect for websites, blogs, and social media.</li>
            ...
            <p>By using a reliable "DOC to JPG converter," you make your document content more versatile for sharing and embedding. This tool is your go-to solution for transforming Word files into a universally compatible image format.</p>
          </article>
