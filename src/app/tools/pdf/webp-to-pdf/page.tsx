...
import { webpToPdf, WebpToPdfOutput } from '@/ai/flows/webp-to-pdf';
import AdBanner from '@/components/ad-banner';

export default function WebpToPdfPage() {
  const [file, setFile] = useState<File | null>(null);
  const [isConverting, setIsConverting] = useState(false);
  const [conversionResult, setConversionResult] = useState<WebpToPdfOutput | null>(null);
  ...
  const convertFile = async () => {
    ...
    try {
      ...
      reader.onload = async () => {
        ...
        try {
          const result = await webpToPdf({ webpDataUri: base64File, fileName: file.name });
        ...
        <main className="lg:col-span-3">
          <Card className="shadow-2xl shadow-primary/10 border-primary/20 bg-card/80 backdrop-blur-sm hidden md:block">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-3xl font-headline">WEBP to PDF Converter</CardTitle>
              <CardDescription className="text-lg">
                Effortlessly convert your WEBP image files into professional, high-quality PDFs.
              </CardDescription>
            </CardHeader>
          </Card>
          <Card className="md:mt-12">
            <CardHeader className="md:hidden">
              <CardTitle>WEBP to PDF Converter</CardTitle>
            </CardHeader>
          ...
          <article className="mt-16 prose prose-lg dark:prose-invert max-w-none prose-h2:font-headline prose-h2:text-3xl prose-h2:text-primary prose-a:text-primary">
            <h2 id="about-tool">Convert WEBP Images to PDF Seamlessly</h2>
            <p>Our WEBP to PDF converter offers a straightforward solution to convert modern WEBP images into universally compatible PDF documents. WEBP is a fantastic format for the web, but PDF is often preferred for printing, sharing, and archiving documents. This tool bridges that gap, allowing you to quickly embed your WEBP images into a standard PDF file.</p>
            <AdBanner type="top-banner" className="my-8"/>
            <h2 id="how-it-works">How Does WEBP to PDF Conversion Work?</h2>
            <p>The process is simple. Upload your WEBP image, and our system will embed it into a standard PDF page. The converter ensures that the image quality is preserved during the process, resulting in a high-fidelity PDF document. Your privacy is important; all files are handled securely and automatically deleted from our servers after processing.</p>
            <h3 id="key-features">Key Features and Benefits</h3>
            <ul>
              <li><strong>High-Quality Conversion:</strong> Retains the visual quality of your original WEBP image.</li>
              <li><strong>Standardized Format:</strong> Create PDFs that are easy to share, print, and view on any device.</li>
              <li><strong>User-Friendly Interface:</strong> Simply drag and drop your WEBP file to start the conversion.</li>
              <li><strong>Secure and Private:</strong> Your files are encrypted during transfer and are not stored long-term.</li>
              <li><strong>Completely Free:</strong> Convert your WEBP images to PDF for free, without limits.</li>
            </ul>
            <p>Experience the simplicity and quality of our free online conversion tool today and make your WEBP images more versatile!</p>
          </article>
