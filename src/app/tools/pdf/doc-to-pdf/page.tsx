...
import { docToPdf, DocToPdfOutput } from '@/ai/flows/doc-to-pdf';
...
export default function DocToPdfPage() {
  ...
  const [conversionResult, setConversionResult] = useState<DocToPdfOutput | null>(null);
  ...
  const convertFile = async () => {
    ...
    try {
      ...
      reader.onload = async () => {
        ...
        try {
          const result = await docToPdf({ docDataUri: base64File, fileName: file.name });
        ...
        <main className="lg:col-span-3">
          <Card className="shadow-2xl shadow-primary/10 border-primary/20 bg-card/80 backdrop-blur-sm">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-3xl font-headline">DOC to PDF Converter</CardTitle>
              <CardDescription className="text-lg">
                Convert your Word documents (.doc, .docx) to high-quality PDFs in seconds.
              </CardDescription>
            </CardHeader>
              ...
              {!conversionResult && (
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <Input id="file-upload" type="file" className="sr-only" onChange={handleFileChange} accept=".doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document" disabled={isConverting} />
                  </Label>
          ...
          <article className="mt-16 prose prose-lg dark:prose-invert max-w-none prose-h2:font-headline prose-h2:text-3xl prose-h2:text-primary prose-a:text-primary">
            <h2 id="about-tool">Seamless Word to PDF Conversion</h2>
            <p>Our DOC to PDF converter provides an easy and reliable way to turn your Microsoft Word documents into universal PDF files. PDF is the standard for sharing documents because it preserves formatting across all devices. Whether you need to submit a resume, send a report, or archive a document, converting it to PDF ensures it will look exactly as you intended. This tool handles both legacy `.doc` files and modern `.docx` files.</p>
            <AdBanner type="top-banner" className="my-8"/>
            <h2 id="how-it-works">How Does DOC to PDF Conversion Work?</h2>
            <p>The process is simple. When you upload your Word document, our system uses an advanced conversion engine to replicate your file's content—including text, images, tables, fonts, and formatting—into a high-quality PDF. The layout is preserved, so your headers, footers, and page breaks appear just as they did in Word. We prioritize your privacy; all files are handled securely and are automatically deleted from our servers after processing.</p>
            <h3 id="key-features">Key Features and Benefits</h3>
            <ul>
              <li><strong>High-Fidelity Conversion:</strong> Retains the original layout, fonts, and images of your Word document.</li>
              ...
              <li><strong>Completely Free:</strong> Convert as many Word documents to PDF as you need, at no cost.</li>
            </ul>
